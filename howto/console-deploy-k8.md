...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSVKZ7_2.5.3/blockchain-sw-253/howto/console-deploy-k8.html](https://www.ibm.com/docs/en/SSVKZ7_2.5.3/blockchain-sw-253/howto/console-deploy-k8.html){: external}. Update your bookmarks.
{: important}

# Deploying {{site.data.keyword.blockchainfull_notm}} Platform 2.5.3
{: #deploy-k8}
